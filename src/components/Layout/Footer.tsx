    ...
    <footer className="bg-white dark:bg-gray-800 shadow-inner py-6 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-600 dark:text-gray-300 mb-4 md:mb-0 transition-colors duration-300">
            © {currentYear} Haritha Mandanapu All rights reserved.
          </div>
          
          <div className="flex space-x-4">
            <a 
              href="https://github.com/hmandana" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/haritham/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-cyan-500 dark:text-gray-400 dark:hover:text-cyan-400 transition-colors duration-300"
              aria-label="LinkedIn"
